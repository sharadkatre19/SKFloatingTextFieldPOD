...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shantaramk/SKFloatingTextField'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shantaramk' => 'sharadkatre01@gmail.com' }
  s.source           = { :git => 'https://github.com/shantaramk/SKFloatingTextField.git', :tag => s.version.to_s }
